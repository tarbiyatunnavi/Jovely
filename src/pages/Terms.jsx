      ...
      <div className="page fade-in">
        <div className="card">
          ...
          <div className="col" style={{ gap: 16, fontSize: 14, lineHeight: 1.6, color: 'var(--ink-soft)' }}>
            <p><strong>1. Penggunaan Aplikasi</strong><br />Jovely adalah aplikasi self-assessment reflektif untuk dewasa muda (18+). Dengan menggunakan aplikasi, kamu setuju untuk menggunakan hasil secara reflektif dan tidak menggantikan konsultasi profesional.</p>
